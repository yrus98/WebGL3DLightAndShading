...
export default class Shader
{
	...
	setUniform1f(uniformLocation, val)
	{
		this.gl.uniform1f(uniformLocation, val);
	}

	setUniform3f(uniformLocation, vector3)
	{
		this.gl.uniform3f(uniformLocation, ...vector3);
	}

	setUniform4f(uniformLocation, vector4)
	{
		this.gl.uniform4f(uniformLocation, ...vector4);
	}
